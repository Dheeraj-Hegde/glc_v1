...
async def main():
    ...
    print(f"-> Sample Rate: {result1.sample_rate} Hz, Provider: {result1.provider}, Cost: ${result1.cost_usd:.2f}")
    print("=============================================================")
    ...
    print(f"-> Sample Rate: {result2.sample_rate} Hz, Provider: {result2.provider}, Cost: ${result2.cost_usd:.2f}")
    print("=============================================================")
    ...
    print(f"-> Sample Rate: {result3.sample_rate} Hz, Provider: {result3.provider}, Cost: ${result3.cost_usd:.2f}")
    print("=============================================================")
